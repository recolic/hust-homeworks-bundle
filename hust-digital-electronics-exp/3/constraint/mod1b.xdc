...
set_property PACKAGE_PIN U9 [get_ports {_i}]					
set_property IOSTANDARD LVCMOS33 [get_ports {_i}]
...
set_property PACKAGE_PIN T8 [get_ports {_o}]					
set_property IOSTANDARD LVCMOS33 [get_ports {_o}]
