...
#set_property PACKAGE_PIN U9 [get_ports {addr_3b[0]}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {addr_3b[0]}]
###Bank = 34, Pin name = IO_25_34,							Sch name = SW1
#set_property PACKAGE_PIN U8 [get_ports {addr_3b[1]}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {addr_3b[1]}]
###Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
#set_property PACKAGE_PIN R7 [get_ports {addr_3b[2]}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {addr_3b[2]}]
#
...
#set_property PACKAGE_PIN T6 [get_ports {out_data_4b[0]}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {out_data_4b[0]}]
###Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
#set_property PACKAGE_PIN T5 [get_ports {out_data_4b[1]}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {out_data_4b[1]}]
###Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
#set_property PACKAGE_PIN T4 [get_ports {out_data_4b[2]}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {out_data_4b[2]}]
###Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LED6
#set_property PACKAGE_PIN U7 [get_ports {out_data_4b[3]}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {out_data_4b[3]}]
#
