...
# 38 "c:\\mingw\\include\\winsock2.h" 3
...
# 13 "c:\\mingw\\include\\objbase.h" 2 3
#pragma pack(push,8)
...
product products[6] = {{"scala", 30, 70, '?'},{"java", 500, 500, '?'},{"golang", 60, 50, '?'},{"C++1z", 1000, 1100, '?'},{"Python", 10, 1000, '?'},{"Assembly", 100000, 1, '?'}};
...
SetWindowTextA
# 30 "impl.c"
             (hShowWin, "Calculation done.");
 calc_done = 
# 31 "impl.c" 3
            1
# 31 "impl.c"
                ;
 for(int cter = 0; cter < 6; ++cter) {
...
void show_list() {
 char buf[28*6 + sizeof("name    in_price out_price grade\r\n")] = "name    in_price out_price grade\r\n";
 int pos = sizeof("name    in_price out_price grade\r\n") - 1;
 for(int cter = 0; cter < 6; ++cter, pos += 28) {
